        ...
        <div class="card">
            ...
            <div class="card-body">
                @if (session('success'))
                    ...
                    @endif
                <form class="form form-vertical" method="post" action="/add_department/store">
                    @csrf
                    <div class="form-body">
                    <div class="row">
                    <div class="col-12">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control" placeholder="Input Department" name="department_short_name" value="{{ old('department_short_name') }}">
                    ...
                    <div class="col-12">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control" placeholder="Input Department Name" name="department_name" value="{{ old('department_name') }}">
                                <div class="form-control-icon">
                                    <i class="fa fa-table"></i>
                                </div>

        ...
        <div class="card">
            ...
            <div class="card-body">
                @if (session('success'))
                    ...
                    @endif
                <form class="form form-vertical" method="post" action="/manage_department/{{ $id -> id }}">
                    @csrf
                    @method('patch')
                    <div class="form-body">
                    <div class="row">
                    <div class="col-12">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control" placeholder="Input Department" name="department_short_name" value="{{ $id -> department_short_name }}">
                    ...
                    <div class="col-12">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control" placeholder="Input Department Name" name="department_name" value="{{ $id -> department_name }}">
                                <div class="form-control-icon">
                                    <i class="fa fa-table"></i>
                                </div>

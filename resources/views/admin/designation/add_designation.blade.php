...
<div class="card">
    ...
    <div class="card-body">
        @if (session('success'))
                    ...
                    @endif
        <form class="form form-vertical" method="post" action="/add_designation/store">
            @csrf
        <div class="form-body">
            <div class="row">
            <div class="col-12">
                <div class="form-group has-icon-left">
                    ...
                    <div class="position-relative">
                        <input type="text" class="form-control" placeholder="Input Designation" name="input_designation" value="{{ old('input_designation') }}">
            ...
            <div class="col-12">
                <div class="form-group has-icon-left">
                    ...
                    <div class="position-relative">
                        <input type="text" class="form-control" placeholder="Input Description" name="input_description" value="{{ old('input_description') }}">
                        <div class="form-control-icon">
                            <i class="fa fa-table"></i>
                        </div>

...
<div class="card">
    ...
    <div class="card-body">
        @if (session('success'))
                    ...
                    @endif
        <form class="form form-vertical" method="post" action="/manage_designation/{{ $id -> id }}">
            @csrf
            @method('patch')
        <div class="form-body">
            <div class="row">
            <div class="col-12">
                <div class="form-group has-icon-left">
                    ...
                    <div class="position-relative">
                        <input type="text" class="form-control" placeholder="Input Designation" name="input_designation" value="{{ $id -> input_designation }}">
                        <div class="form-control-icon">
                            <i class="fa fa-table"></i>
                        </div>
                        @error('input_designation')
            ...
            <div class="col-12">
                <div class="form-group has-icon-left">
                    ...
                    <div class="position-relative">
                        <input type="text" class="form-control" placeholder="Input Description" name="input_description" value="{{ $id -> input_description }}">
                        <div class="form-control-icon">
                            <i class="fa fa-table"></i>
                        </div>

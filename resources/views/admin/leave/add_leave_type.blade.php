...
<div class="card">
    ...
    @endif
        <form class="form form-vertical" method="POST" action="/add_leave_type/store">
            @csrf
        <div class="form-body">
            <div class="row">
            <div class="col-12">
                <div class="form-group has-icon-left">
                    ...
                    <div class="position-relative">
                        <input type="text" class="form-control" placeholder="Input leave type" name="leave_name" value="{{ old('leave_name') }}">
            ...
            <div class="col-12">
                <div class="form-group has-icon-left">
                    ...
                    <div class="position-relative">
                        <input type="text" class="form-control" placeholder="Input Description" name="description" value="{{ old('description') }}">
                        <div class="form-control-icon">
                            <i class="fa fa-table"></i>
                        </div>
                        @error('description')
            ...
            <div class="col-12">
                <div class="form-group has-icon-left">
                    ...
                    <div class="position-relative">
                        <input type="text" class="form-control" placeholder="Input days allowed" name="days_allowed" value="{{ old('days_allowed') }}">
                        <div class="form-control-icon">
                            <i class="fa fa-table"></i>
                        </div>
                        @error('days_allowed')

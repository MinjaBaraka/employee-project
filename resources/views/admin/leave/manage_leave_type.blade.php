                        ...
                        <tbody>
                            ...
                            @foreach($leave as $leaves)
                                <tr>
                                    ...
                                    <td>{{ $leaves -> days_allowed }}</td>

                                   
                                    <td>{{ $leaves -> created_at }}</td>
                                    <td><a href="/manage_leave_type/{{ $leaves -> id }}/edit_leave_type"><button class="btn btn-outline-success">Edit</button></a></td>
                                    <td>
                                        <form action="/manage_leave_type/{{ $leaves -> id }}" method="POST">
                                            @csrf
                                            @method('DELETE')

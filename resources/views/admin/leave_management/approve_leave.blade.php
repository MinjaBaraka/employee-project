                ...
                @endif
                    <table class='table' id="table1">
                        ...
                        <tbody>
                            ...
                            @foreach($approve as $all_leaves)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/update_status/{{ $all_leaves->id }}/1"><span class="badge bg-success">Pending</span></a>
                            ...
                            @else
                            <i class="text-danger">No Approve exists</i>
                            @endif
